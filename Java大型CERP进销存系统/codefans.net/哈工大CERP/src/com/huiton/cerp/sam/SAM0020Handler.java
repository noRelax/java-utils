...
public class SAM0020Handler extends RequestHandlerSupport
{

    public SAM0020Handler()
    {
    }
    ...
    {
        Debug.println("----SAM0020Handler: processRequest()");
        ...
        strConditions = " 1=1 order by driver_code ";

        strFields = "driver_code,driver_manager" ;
        strTables = "scg_driver_manager";
        ...
        try
        {
            PageQuery pageQuery = DBOperators.getPageQuery(request,
                sessionCode,SubsystemKeys.SAM, "SAM0020Handler");
