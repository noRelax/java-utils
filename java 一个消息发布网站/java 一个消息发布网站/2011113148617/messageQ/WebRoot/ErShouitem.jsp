...
<li class="menu_line"></li>
<li><br /></li>
<li class="menu_line"></li><li><br /></li>
<li class="menu_line"></li><li><a href="ZuFangProServlet" onmouseover="javascript:qiehuan(5)" id="mynav5" class="nav_on"><span>出租房子</span></a></li><li class="menu_line"></li> 
...
<%
	ErShou con=(ErShou)request.getAttribute("obj");
	if(con!=null){
 %>
<tr>
<td width="55">标题:</td>
