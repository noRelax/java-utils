...
<li class="menu_line"></li>
<li><br /></li>
<li class="menu_line"></li><li><a href="#" onmouseover="javascript:qiehuan(6)" id="mynav6" class="nav_on"><span>出租房子</span></a></li>
...
<%
	Content con=(Content)request.getAttribute("obj");
	if(con!=null){
 %>
<tr>
<td width="55">标题:</td>
