...
public class ErShouServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(idstr!=null)
		{
			...
			ErShouService condao=new ErShouService();
			List list=condao.Lookid(id, 1, 1, new ErShouDAO());
			if(list.iterator().hasNext()){
				ErShou con=(ErShou)list.iterator().next();
				request.setAttribute("obj", con);
				RequestDispatcher re=request.getRequestDispatcher("ErShouitem.jsp");
