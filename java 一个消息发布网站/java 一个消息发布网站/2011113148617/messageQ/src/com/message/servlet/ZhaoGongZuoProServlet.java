...
public class ZhaoGongZuoProServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ZhaoGongZuoProServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ZhaoGongZuoService ser4=new ZhaoGongZuoService();
		DataDAOImp condao4=new ZhaoGongZuoDAO();
		List li4=ser4.LookAll( nowpage, 15, condao4);
		request.setAttribute("chushou", li4);
		request.setAttribute("nowpage", nowpage);
		RequestDispatcher re=request.getRequestDispatcher("zhaogongzuo.jsp");
