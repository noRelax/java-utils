...
public class ErShouProServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ErShouProServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ErShouService ser4=new ErShouService();
		DataDAOImp condao4=new ErShouDAO();
		List li4=ser4.LookAll( nowpage, 15, condao4);
		request.setAttribute("chushou", li4);
		request.setAttribute("nowpage", nowpage);
		RequestDispatcher re=request.getRequestDispatcher("maidongxi2.jsp");
