...
public class EmpUpdDialog extends JDialog implements ActionListener{
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(arg0.getSource()==jb1)
		{
			...
			String sql = "update  renshiziliao set username=?,sex=?,birth=?,id=?,xueli = ?," +
					"married = ?,phone1 = ?,phone2 = ?,youxiang = ?,zhuceshijian =?,beizu = ?,zhiwei = ? where userid=?" ;
			...
			String[] paras = {jtf2.getText(),jtf3.getText(),jtf4.getText(),jtf5.getText(),
					...
					jtf12.getText(),jtf13.getText(),jtf1.getText()};
