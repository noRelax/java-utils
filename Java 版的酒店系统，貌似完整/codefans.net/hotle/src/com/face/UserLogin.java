			...
			if(Manager.isSelected())
			{
				try
				{
					...
					while(rs.next())
					{
						...
						{
							//JOptionPane.showMessageDialog(junshuaizhang, "登陆成功");
							//this.setVisible(false);
							this.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);//此处产生Exception in thread "AWT-EventQueue-0" java.lang.IllegalArgumentException: defaultCloseOperation mus的错误如用Exite_to_close
