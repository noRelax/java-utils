...
public class ChangePass extends JDialog  implements ActionListener{
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(arg0.getSource()==jb1)
		{
			...
			this.getContentPane().remove(jtf1); 
			this.getContentPane().repaint(); 
			
			
			
			em = new EmpModel();
			String get_jtf4 = jtf4.getText();
			System.out.print("     在文本框1中输入的新密码为:"+get_jtf4);
			String paras1 [] = {get_jtf4};
			em.query("select * from login where userid = ?", paras1);
			changpass_b = em.b;
			if(!changpass_b)
			{
			...
			else if(changpass_b &&jtf2.getText().equals(jtf3.getText()))
			{
				...
				em = new EmpModel();
				String [] paras_changepass = {jtf2.getText()};
