...
public class Client extends JFrame implements ActionListener
{
	...
	private JLabel secondflight=new JLabel("第二航班号:");
	private JLabel secondtime=new JLabel("    第二时间:");
	...
	static JTextField jbtchildticketnumber=new JTextField("0",12);
	...
	{	
		...
		p12.add(secondflight);
		returnflight.setVisible(false);
		secondflight.setVisible(false);
	...
	public JPanel panel(String[] string)
	{
		...
		else if(string[5].equals("联程"))
		{
			...
			string[10]=string[17];
			string[11]=string[16];
			secondflight.setVisible(true);
			secondtime.setVisible(true);
			returnflight.setVisible(false);
			returntime.setVisible(false);
		}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{			
			...
			{
				if(Integer.parseInt(jbtadultticketnumber.getText().trim())==0&&Integer.parseInt(jbtchildticketnumber.getText().trim())==0)
				{
		...
		if(e.getSource()==return1)
		{
			...
			jbtchildticketnumber.setText("0");
			jbttelephone.setText("0");
		}
