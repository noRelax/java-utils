 ...
 * 
 */
public class CmppTerminateRespHander extends CmppHander
{
	...
	public Packet packetBuiler(byte[] packbytes) throws Exception
	{
		...
		CmppTerminateRespBuilder ctrb =new CmppTerminateRespBuilder();
		
		
		ctrb.setSequenceId(Bytes4ToInt(packbytes,4));
