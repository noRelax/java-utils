...
import com.itstar.erp.bean.OutStock;
 ...
 * @author Zhang Li
 */
public class ShowOutStock extends JFrame {
	...
	private JTable getJTable_ShowAll() {
		String[] showName = { "销售单编号", "商品编号", "数量", "责任人", "时间"};
		new OutStock();
		if (jTable_ShowAll == null) {
			jTable_ShowAll = new JTable(OutStock.selectOutStock(), showName);
		}
	...
	private JTable getJTable_ShowOne(String sName) {
		String[] showName = { "责任人", "商品编号", "数量", "销售单编号", "时间"};
		new OutStock();

		jTable_ShowOne = new JTable(OutStock.selectOutStock(sName), showName);
		...
		if (jButton == null) {
			...
			jButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					jScrollPane1
							.setViewportView(getJTable_ShowOne(jTextField_Name.getText()));
