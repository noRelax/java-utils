...
public class GuestInfo extends JFrame {
	...
	private JTabbedPane getJTabbedPane() {
		if (jTabbedPane == null) {
			...
			jTabbedPane.addTab("客户新增", null, getJPanel(), null);
			jTabbedPane.addTab("客户修改和删除", null, getJPanel1(), null);
		}
		return jTabbedPane;
	}
