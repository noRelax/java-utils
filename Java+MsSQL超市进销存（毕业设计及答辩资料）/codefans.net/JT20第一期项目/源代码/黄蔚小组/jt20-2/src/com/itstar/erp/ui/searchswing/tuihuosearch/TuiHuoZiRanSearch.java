...
public class TuiHuoZiRanSearch {
	...
	public void init(){
		...
		String[] colnames={"退货编号","销售编号","商品名称","商品进价","销售价格","销售数量","退货数量","退货金额","销售时间","退货时间","退货原因","经手人"}; 
...
//				{"退货编号","销售编号","商品名称","商品进价","销售价格","销售数量","退货数量","退货金额","销售时间","退货时间","退货原因","经手人"};         
//				
				cells[j][0]="TH"+ttime+"_"+(1000+tuihuoid);
				cells[j][1]="XS"+xtime+"_"+(1000+sellid);
				...
				cells[j][7]=String.valueOf(tuihuojine).trim()+"   元";
