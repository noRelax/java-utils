...
public class TuiKuZiRanSearch {
	...
	public void init(){
		...
		String[] colnames={"退库编号","入库编号","商品名称","商品进价","入库数量","退库数量","退库金额","入库时间","退库时间","退库原因","经手人"}; 
...
//		{"退库编号","入库编号","商品名称","商品进价","入库数量","退库数量","退库金额","入库时间","退库时间","退库原因","经手人"};
//				
				cells[j][0]="TK"+ttime+"_"+(1000+tuikuid);
				...
				cells[j][6]=String.valueOf(tuikujine).trim()+"     元";
