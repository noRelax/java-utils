...
public class SellLiangdxSearch {
...
//		String s="DESC";
		try{
			rs=new GetRS().getResultSet("select * from tb_sell_info order by sellAcount desc ");
		}catch(Exception e){
			JOptionPane.showMessageDialog(null, this, "格式错误，格式为  从 2009-07-22 到 2009-07-28", 0);
		}
		
		String[] colnames={"销售数量","商品名称","商品进价","销售价格","销售编号","客户名称","经手人","销售金额","盈利","销售时间"}; 
