...
public class TuiHuoTimeSearch {
	
	
	
	
	public static void main(String[] args){
//		new TuiHuoTimeSearch().init();
	}
	...
	public void init(String time1,String time2){
		...
		Object[][] cells;
		ResultSet rs=new GetRS().getResultSet("select * from tb_tuihuo_info where thTime between '"+time1+"' and '"+time2+"'");
		String[] colnames={"退货时间","销售编号","商品名称","商品进价","销售价格","销售数量","退货金额","退货编号","销售时间","退货数量","退货原因","经手人"}; 
...
//				{"退货编号","销售编号","商品名称","商品进价","销售价格","销售数量","退货数量","退货金额","销售时间","退货时间","退货原因","经手人"};         
//				
				cells[j][0]=String.valueOf(ttime).trim();
				...
				cells[j][10]=String.valueOf(tuihuoacount).trim();
