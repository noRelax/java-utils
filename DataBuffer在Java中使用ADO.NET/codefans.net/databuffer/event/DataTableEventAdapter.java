/*
 * $Id: DataTableEventAdapter.java,v 1.4.2.1 2006/01/21 05:25:10 david_hall Exp $
 *
 ...
 * event type on capturing an event directly. To use this class, create an instance and assign it to a {@link org.jdesktop.databuffer.DataTable} using
 * {@link org.jdesktop.databuffer.DataTable#addDataTableListener(DataTableListener)}.
 *
...
//     public void columnRemoved(TableChangeEvent evt) {}    
    ...
    /**
     * Fired when a column is changed int the table.
     * @param evt The TableChangeEvent capturing the change.
     */
